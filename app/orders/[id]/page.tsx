                      ...
                      <div className="flex-1 space-y-1">
                        ...
                        {item.variant?.variantAttributes && (
                          <div className="text-sm text-muted-foreground">
                            {item.variant.variantAttributes.map((attr, index) => (
                              <span key={attr.attribute.name}>
                                {attr.attribute.displayName}: {attr.attributeOption.displayValue}
                                {index < item.variant!.variantAttributes!.length - 1 && ', '}
                              </span>
                            ))}
                          </div>
                        )}
