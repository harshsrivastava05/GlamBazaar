...
export const metadata: Metadata = {
  ...
  description: 'Premium jewelry and cosmetics e-commerce platform with same-day delivery in Kanpur',
  keywords: ['jewelry', 'cosmetics', 'e-commerce', 'diamonds', 'makeup', 'skincare'],
